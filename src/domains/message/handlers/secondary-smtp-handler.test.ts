...
import SecondarySmtpHander from './secondary-smtp-handler';


it('handles normally', async()=>{
  // get the hander
  const handler = container.get<SecondarySmtpHander>(IDENTIFIERS.SecondarySmtpHander);

  // create message
  const doc = {
    id: '51e11e09-092b-4c10-91e5-1165981795ac',
    from: 'info@powerkernel.net',
    to: 'SecondarySmtpHander@powerkernel.net',
    subject: 'Welcome',
